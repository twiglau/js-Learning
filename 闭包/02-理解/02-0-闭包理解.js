/**
 * 在JavaScript里面,函数,块,模块都可以形成作用域(一个存放变量的独立空间),它们之间可以相互
 * 嵌套,作用域之间会形成引用关系,这条链叫做作用域链.
 * 
 * 作用域链具体是什么样呢?
 * 
 * 以下代码
...
//     }
// }
//其中,有guang,ssh,suzhe3个变量,有func,func2,func3 3个函数,还有一个块,它们之间
//的作用域链可以用babel查看下.
...
traverse(ast, {
  ...
  //用图可视化是02-2
  /**
   * 函数和块的作用域内的变量声明会在作用域(scope)内创建一个绑定(变量名绑定到具体的值,也就是binding),
